...
Label(root,text ="BHARATINTERN", font = 'arial 16', fg='black', bg='skyblue' , height = '5', width = '20').pack(side = 'bottom')
...
src_lang = ttk.Combobox(root, values= ('english','hindi','german','french'), width =22)
src_lang.place(x=20,y=60)
src_lang.set('Select input language')

dest_lang = ttk.Combobox(root, values= ('english','hindi','german','french'), width =22)
